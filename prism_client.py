...
class PrismClient:
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            self.log_manager.log_info("Prism client initialized successfully",
    ...
    def start(self) -> None:
        ...
        try:
            if self.daemon_mode:
                self.log_manager.log_info("Starting Prism client in daemon mode",
                                        component="PrismClient")
                ...
                self.log_manager.log_info("Starting Prism client in foreground mode",
                                        component="PrismClient")
                ...
                try:
                    ...
                    self.log_manager.log_info("Heartbeat manager started",
                                            component="PrismClient")
                    ...
                    self.log_manager.log_info("Received interrupt signal",
                                            component="PrismClient")
                finally:
                    heartbeat_manager.stop()
                    self.log_manager.log_info("Heartbeat manager stopped",
                                            component="PrismClient")
    ...
    def stop(self) -> None:
        ...
        if self.service_manager:
            self.log_manager.log_info("Stopping Prism client",
                                    component="PrismClient")
    ...
    def _signal_handler(self, signum: int, frame) -> None:
        ...
        if self.log_manager:
            self.log_manager.log_info(f"Received signal: {signal_name}",
                                    component="PrismClient")
        self.stop()
        sys.exit(0)
