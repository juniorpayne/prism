...
"""
        ...
        error_handler.handle_exception(test_error, component="DemoComponent", operation="testing")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for i, scenario in enumerate(error_scenarios, 1):
            ...
            error_handler.handle_exception(
                scenario["error"], component=scenario["component"], operation=scenario["operation"]
            )
