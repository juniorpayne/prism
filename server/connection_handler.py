...
class ConnectionHandler:
    ...
    async def _process_message(self, message: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if not is_valid:
                logger.warning(f"Message validation failed for {self.client_ip}: {validation_error}")
    ...
    async def _handle_registration(self, message: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if success:
                logger.info(f"Successfully registered hostname '{hostname}' with IP {self.client_ip}")
            ...
            if existing_host:
                ...
                if existing_host.current_ip != ip_address:
                    ...
                    if success:
                        ...
                        return True, f"Host IP updated from {existing_host.current_ip} to {ip_address}"
                    else:
    ...
    async def remove_connection(self, connection_handler: ConnectionHandler) -> None:
        ...
        async with self._connection_lock:
            ...
            if connection_id in self.active_connections:
                ...
                logger.info(f"Removed connection {connection_id}, active: {len(self.active_connections)}")
