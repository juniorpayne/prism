...
class RegistrationResult:
    ...
    success: bool
    result_type: str  # new_registration, ip_change, heartbeat_update, reconnection, validation_error, etc.
    message: str
    hostname: str
    ip_address: str
    timestamp: str = None
...
class RegistrationConfig:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        logger.info(f"Registration processor configured: ip_tracking={self.enable_ip_tracking}, "
...
class RegistrationProcessor:
    ...
    async def process_registration(
        ...
        try:
            ...
            logger.info(f"Registration processed: {result.result_type} for {hostname} "
    ...
    async def _check_rate_limit(self, client_ip: str) -> RegistrationResult:
        ...
        self._rate_limit_tracker[client_ip] = [
            timestamp for timestamp in self._rate_limit_tracker[client_ip]
    ...
    async def _check_duplicate_registration(self, hostname: str, client_ip: str) -> Optional[RegistrationResult]:
        """
    ...
    async def _process_new_host_registration(self, hostname: str, client_ip: str) -> RegistrationResult:
        """
            ...
            if existing_host.status == 'offline':
                ...
                if existing_host.current_ip != client_ip:
                    ...
                    if success:
                        ...
                        logger.info(f"Host reconnected with IP change: {hostname} "
