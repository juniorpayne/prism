...
class ResponseBuilderConfig:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        logger.info(f"Response builder configured: format={self.message_format}, "
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._templates = {
            'success': ResponseTemplate(
                ...
                optional_fields=[
                    'result_type', 'hostname', 'ip_address', 'previous_ip',
                    'previous_status', 'server_info', 'statistics', 'processing_time_ms'
                ]
            ),
            'error': ResponseTemplate(
                ...
                required_fields=['version', 'type', 'status', 'message', 'timestamp'],
                optional_fields=[
                    'error_type', 'hostname', 'ip_address', 'retry_after',
                    'server_info', 'error_code'
                ]
            )
        }
