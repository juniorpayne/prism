...
async def get_health(
    ...
    try:
        ...
        logger.debug(f"Health check completed - uptime: {uptime:.1f}s, hosts: {stats.get('total_hosts', 0)}")
...
async def get_statistics(
    ...
    try:
        ...
        uptime_info = {
            ...
            'server_start_time': datetime.fromtimestamp(_server_start_time, tz=timezone.utc).isoformat(),
        ...
        database_statistics = {
            ...
            'connection_pool_size': db_manager.pool_size if hasattr(db_manager, 'pool_size') else 'N/A',
