...
async def list_zones(
    ...
    try:
        async with get_powerdns_client() as dns_client:
            ...
            zones_response = await dns_client._make_request("GET", "servers/localhost/zones")
...
async def get_zone(
    ...
    try:
        async with get_powerdns_client() as dns_client:
            ...
            zone_response = await dns_client._make_request(
                "GET", f"servers/localhost/zones/{zone_id}"
            )
