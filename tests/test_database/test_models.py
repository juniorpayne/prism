...
class TestDatabaseModels(unittest.TestCase):
    ...
    def test_host_model_fields(self):
        ...
        required_fields = [
            'id', 'hostname', 'current_ip', 'first_seen', 
        ...
        for field in required_fields:
            self.assertTrue(
                hasattr(Host, field),
                f"Host model should have {field} field"
            )
    ...
    def test_host_model_field_types(self):
        ...
        for field_name, expected_type in field_types.items():
            ...
            self.assertIsInstance(
                ...
                f"{field_name} should be of type {expected_type}"
            )
    ...
    def test_host_model_indexes(self):
        ...
        hostname_column = getattr(Host, 'hostname')
        self.assertTrue(
            hostname_column.property.columns[0].index,
            "Hostname should be indexed"
        )
    ...
    def test_host_model_validation_methods(self):
        ...
        for method in expected_methods:
            self.assertTrue(
                hasattr(Host, method),
                f"Host model should have {method} method"
            )
...
class TestDatabaseSchema(unittest.TestCase):
    ...
    def test_hosts_table_constraints(self):
        ...
        hostname_unique = any(
            'hostname' in constraint['column_names']
        ...
        hostname_unique = hostname_unique or (hostname_column and hostname_column.get('unique', False))
