...
class TestDockerEnvironment(unittest.TestCase):
    ...
    def test_server_requirements_exists(self):
        ...
        self.assertTrue(
            ...
            "server/requirements.txt should exist"
        )
    ...
    def test_dockerfile_exposes_ports(self):
        ...
        self.assertTrue(
            "8080" in content or "8081" in content,
            "Dockerfile should expose server ports"
        )
    ...
    def test_development_script_exists(self):
        ...
        self.assertTrue(
            script_path.exists(),
            "Development helper script should exist"
        )
...
class TestDockerFunctionality(unittest.TestCase):
    ...
    def test_docker_build_succeeds(self):
        ...
        self.assertEqual(
            result.returncode, 0,
            f"Docker build should succeed. Error: {result.stderr}"
        )
    ...
    def test_compose_services_start(self):
        ...
        try:
            ...
            self.assertEqual(
                result.returncode, 0,
                f"docker-compose up should succeed. Error: {result.stderr}"
            )
    ...
    def test_development_script_works(self):
        ...
        self.assertIn(
            ...
            "Development script should execute without crashing"
        )
