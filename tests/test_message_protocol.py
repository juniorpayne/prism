...
class TestMessageProtocol:
    ...
    def test_message_validation_failure(self):
        ...
        invalid_messages = [
            ...
            {'version': '2.0', 'type': 'registration', 'timestamp': '2025-01-06T12:00:00Z', 'hostname': 'test'},  # Invalid version
            {'version': '1.0', 'type': 'invalid', 'timestamp': '2025-01-06T12:00:00Z', 'hostname': 'test'},  # Invalid type
            {'version': '1.0', 'type': 'registration', 'timestamp': 'invalid-timestamp', 'hostname': 'test'},  # Invalid timestamp
            {'version': '1.0', 'type': 'registration', 'timestamp': '2025-01-06T12:00:00Z', 'hostname': ''},  # Empty hostname
            {'version': '1.0', 'type': 'registration', 'timestamp': '2025-01-06T12:00:00Z', 'hostname': None},  # None hostname
        ]
