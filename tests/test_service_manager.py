    ...
    def test_daemon_mode_initialization(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                )  # Skip actual daemonization for testing
                daemon.create_pid_file()
...
class TestServiceManager:
    ...
    def test_service_initialization(self):
        ...
        config = {
            "service": {"name": "prism-client", "description": "Prism Host Client Service"},
    ...
    def test_service_logging_in_daemon_mode(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            service_manager._log_manager.log_info(
                "Service starting in daemon mode", component="ServiceManager"
            )
    ...
    def test_service_context_manager(self):
        ...
        with (
            patch("client.service_manager.HeartbeatManager"),
