...
def test_logging_integration_with_heartbeat_manager():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with patch('socket.socket'), patch('threading.Timer'):
            ...
            with patch.object(heartbeat_manager._connection_manager, 'connect_with_retry',
...
"""
    ...
    try:
        ...
        log_manager.log_info("Integration test message", 
...
def test_logging_performance_under_load():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for i in range(1000):
            log_manager.log_debug(f"Performance test message {i}",
