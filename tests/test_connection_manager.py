...
class TestConnectionManager:
    ...
    def test_connection_timeout(self):
        ...
        config = {"server": {"host": "unreachable.host", "port": 8080, "timeout": 5}}
    ...
    def test_retry_logic_exponential_backoff(self):
        ...
        config = {"server": {"host": "localhost", "port": 8080, "timeout": 5}}
    ...
    def test_configuration_loading(self):
        ...
        mock_config = {"server": {"host": "test.example.com", "port": 9090, "timeout": 15}}
