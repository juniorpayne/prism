...
class TestLogManager:
    ...
    def test_console_logging(self):
        ...
        config = {"logging": {"level": "DEBUG", "console": True, "file": None}}
    ...
    def test_error_handling_no_crashes(self):
        ...
        config = {"logging": {"level": "ERROR", "console": True, "file": None}}
...
class TestErrorHandler:
    ...
    def test_exception_handling_with_logging(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            config = {"logging": {"level": "ERROR", "file": log_file, "console": False}}
            ...
            error_handler.handle_exception(
                test_exception, component="TestComponent", operation="test_operation"
            )
    ...
    def test_exception_handling_no_crash(self):
        ...
        config = {"logging": {"level": "ERROR", "console": False, "file": None}}
